...
Figure S5: Do disentanglement for global domain.
...
plt.ylim(-nhalf-2, 2)
plt.tight_layout()
plt.savefig('../figures/s6_disentanglement_global.pdf', bbox_inches='tight')
plt.savefig('../figures/s6_disentanglement_global.png', bbox_inches='tight')
plt.show()
