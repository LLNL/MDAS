...
Figure S4: Do disentanglement through 2021.
...
fn_ttt_trends = '../data/trends/cmip6_ttt_spliced_trends.pickle'
...
for i, dset in enumerate(['BEST', 'ERA5', 'GISTEMP', 'HadCRUT5']):
    y = -i
    c = obsColors[dset]
...
plt.ylim(-nhalf-2, 2)
plt.tight_layout()
plt.savefig('../figures/s5_disentanglement_through_2021.pdf', bbox_inches='tight')
plt.savefig('../figures/s5_disentanglement_through_2021.png', bbox_inches='tight')
plt.show()
